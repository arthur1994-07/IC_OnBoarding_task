...
namespace IC_OnBoarding_task.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(IC_intershipContext context)
        {
            _context = context;
        }
        ...
        [HttpPut("{id}")]
        public async Task<ActionResult<Product>> Put_Product_by_id(int id, Product product) //FromRoute means from the URL itself
        {
            //if (id != customer.Id)
            if (id != product.Id)
            {
